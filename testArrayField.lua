...
function ArrayFieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name,Image)
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			_Optio[DropdownSettings.Flag] = {Value = DropdownSettings.Items.Selected}
				...
				DropdownOption.Interact.MouseButton1Click:Connect(function()
					...
					if OptionInTable.Selected then
						...
						local Success, Response = pcall(function()
							...
							Dropdown.Changed(DropdownSettings.Items.Selected)
										end)
						end)
						if not Success then
			...
			--fix
			function DropdownSettings:OnChanged(Func)
				Dropdown.Changed = Func;
				Func(DropdownSettings.Items.Selected);
			end
